...
<head>
    ...
    <style>
        ...
        .order-table td:nth-child(1) { width: 8%; }  /* 订单号 */
        .order-table th:nth-child(2),
        .order-table td:nth-child(2) { width: 20%; } /* 客户 */
        .order-table th:nth-child(3),
        .order-table td:nth-child(3) { width: 15%; } /* 金额 */
        .order-table th:nth-child(4),
        .order-table td:nth-child(4) { width: 15%; } /* 状态 */
        .order-table th:nth-child(5),
        .order-table td:nth-child(5) { width: 20%; } /* 时间 */
        .order-table th:nth-child(6),
        .order-table td:nth-child(6) { width: 22%; } /* 操作 */
